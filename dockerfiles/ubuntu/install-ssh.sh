...
23.10)
	cat <<EOF >/etc/apt/sources.list
deb http://mirrors.tencentyun.com/ubuntu/ mantic main restricted universe multiverse
# deb-src http://mirrors.tencentyun.com/ubuntu/ mantic main restricted universe multiverse
deb http://mirrors.tencentyun.com/ubuntu/ mantic-updates main restricted universe multiverse
# deb-src http://mirrors.tencentyun.com/ubuntu/ mantic-updates main restricted universe multiverse
deb http://mirrors.tencentyun.com/ubuntu/ mantic-backports main restricted universe multiverse
# deb-src http://mirrors.tencentyun.com/ubuntu/ mantic-backports main restricted universe multiverse
deb http://mirrors.tencentyun.com/ubuntu/ mantic-security main restricted universe multiverse
# deb-src http://mirrors.tencentyun.com/ubuntu/ mantic-security main restricted universe multiverse
# deb http://mirrors.tencentyun.com/ubuntu/ mantic-proposed main restricted universe multiverse
# # deb-src http://mirrors.tencentyun.com/ubuntu/ mantic-proposed main restricted universe multiverse
EOF
	;;
24.04)
	cat <<EOF >/etc/apt/sources.list
deb http://mirrors.tencentyun.com/ubuntu/ noble main restricted universe multiverse
# deb-src http://mirrors.tencentyun.com/ubuntu/ noble main restricted universe multiverse
deb http://mirrors.tencentyun.com/ubuntu/ noble-updates main restricted universe multiverse
# deb-src http://mirrors.tencentyun.com/ubuntu/ noble-updates main restricted universe multiverse
deb http://mirrors.tencentyun.com/ubuntu/ noble-backports main restricted universe multiverse
# deb-src http://mirrors.tencentyun.com/ubuntu/ noble-backports main restricted universe multiverse
deb http://mirrors.tencentyun.com/ubuntu/ noble-security main restricted universe multiverse
# deb-src http://mirrors.tencentyun.com/ubuntu/ noble-security main restricted universe multiverse
# deb http://mirrors.tencentyun.com/ubuntu/ noble-proposed main restricted universe multiverse
# # deb-src http://mirrors.tencentyun.com/ubuntu/ noble-proposed main restricted universe multiverse
EOF
	;;
*)
